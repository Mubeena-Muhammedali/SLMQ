...
class OrchidProductCorrection(models.Model):
	...
	def button_confirm(self):
		# print("lllllllllkkkkkkjjjjjjjjjjjj")
		if self.record_type=='contract_name':
			...
			for data in result:
				...
				for dl in self.product_line_ds.filtered(lambda x:x.price_adjustment_line.id==data['line']):
					# print("uuuuuunnnnnnnnnn",dl.sale_line_id.price_subtotal)
				...
				# print("orderrrrr3333",price_adjustment_line.order_id.name,price_adjustment_line.order_id.amount_total,price_adjustment_line.price_subtotal)
				...
				for adjust_contract_line_id in adjust_contract_line_ids:
					...
					if adjust_contract_line_id.invoice_line_ids:
						for invoice_line_id in adjust_contract_line_id.invoice_line_ids:
							...
							# print("yesss",invoice_line_id.move_id.name,invoice_line_id.move_id.amount_total,invoice_line_id.price_subtotal)
		elif self.record_type=='contract':
			print("contractttmethod*************************************************")
			print("contractttmethod*************************************************")
			print("contractttmethod*************************************************")
			print("contractttmethod*************************************************")
			print("contractttmethod*************************************************")
