			...
			if po.date_approve:
				for line in po.order_line:
					if line.od_start_date:
						...
						print("kkkkkkkoooooooo",line.od_to_date)
...
class PurchaseOrderLine(models.Model):
	...
	# od_pending_amount = fields.Monetary(string="Pending Amount", currency_field='company_currency_id', readonly=True)
	# od_last_allocation_date = fields.Date(string="Allocation Date")
