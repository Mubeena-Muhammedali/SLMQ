...
class ReportTrialBalance(models.AbstractModel):
    _inherit = 'report.orchid_account_enhancement_v14.report_trial_balance'
    ...
    def _get_accounts(self, accounts, display_account):
        ...
        if not od_context.get('od_with_closing'):
    ...
    def get_account_data_groupby(self,date_from,date_to,accounts,display_account,target_move):
      ...
      if len(accounts.ids)==1:
        ...
        where_qry ="WHERE al.account_id IN "+str(tuple(accounts.ids))
      od_context = dict(self._context or {})
      # print("hhaaassssssssss",self.env.context,od_context,od_context.get('od_with_closing'))
      # print(s)
      if not od_context.get('od_with_closing'):
        where_qry = where_qry + " and aj.od_closing_journal is not true"
      if target_move=='posted':
    ...
    def _get_report_values(self, docids, data=None):
        ...
        #to pass withclosing value to function
        # data['form'].get('used_context').update({'od_with_closing': data['form'].get('od_with_closing')})
