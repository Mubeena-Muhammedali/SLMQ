...
{
    'name': 'Orchid Account Enhancement v14',
    'version': '14.0.1.2.2',
    'category': 'Accounting',
    ...
    'data': [
        ...
        'views/orchid_cost_center.xml',
        'views/account_branch.xml',
        'views/account_division.xml',
        'views/od_payment.xml',
        'views/od_reconciled_lines.xml',
        ...
        'report/od_pdc_report.xml',
        'views/od_bank_voucher.xml',
        'report/report.xml',
