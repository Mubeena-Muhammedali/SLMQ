...
class AccountJournal(models.Model):
    ...
    def _enable_pdc_on_bank_journals(self):
        ...
        via data file.
        """
        pdcin = self.env.ref('orchid_account_enhancement_v14.account_payment_method_pdc_in')
        pdcout = self.env.ref('orchid_account_enhancement_v14.account_payment_method_pdc_out')
