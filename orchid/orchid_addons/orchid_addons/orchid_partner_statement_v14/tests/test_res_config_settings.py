...
class TestResConfigSettings(TransactionCase):
    ...
    def test_groups(self):
        ...
        conf.set_values()
        self.assertFalse(
            self.user_obj._has_group("orchid_partner_statement_v14.group_outstanding_statement")
        )
        self.assertTrue(
            self.user_obj._has_group("orchid_partner_statement_v14.group_activity_statement")
        )
