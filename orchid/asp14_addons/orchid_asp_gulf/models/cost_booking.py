...
class OrchidCostBooking(models.Model):
	...
	def generate_lines(self):
		...
		if self.date:
			...
			print("ttttttttttkkkk",total_cost)
			total_cost = total_cost[0]
			print("nnnbbvccccccc",total_cost)
			self.total_cost = total_cost

			# get_direct_cost_line = self.env['od.direct.costing.line'].search(domain)
			...
			print("ttttttttttkkkk",direct_cost_line)
			...
			print("subscription_line",subscription_line)
			...
			print('llllkkkkk',get_asp_cost_only_po_line)
			self._cr.execute(get_asp_cost_only_po_line)
			asp_cost_only_po_line = self._cr.dictfetchall()
			print("asp_cost_only_po_line",asp_cost_only_po_line)
	...
	def button_confirm(self):
		print("generate entriessss hereeeeeeeee")
		# generate_entries
		line_ls = []
