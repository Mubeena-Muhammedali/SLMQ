        ...
        for move in self:
            ...
            for line in move.line_ids:
                ...
                if move.is_invoice(include_receipts=True):
                    # === Invoices ===
                    print("uuuuuuuuuuuuu",line.exclude_from_invoice_tab,line.name)
                    if not line.exclude_from_invoice_tab:
                        ...
                        print("amt currencyy",line.amount_currency,"totallllaaalllllcurrency",total_currency)
                        print("balanceee",line.balance,"total",total)
            ...
            print("amountyyyyyyyyyyy",sign,total_currency,total,currencies,move.amount_total)
